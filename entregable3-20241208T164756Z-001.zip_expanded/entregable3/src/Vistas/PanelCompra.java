...
public class PanelCompra extends JPanel{
	...
	public void convertir(Moneda monedaDestino) {
		try {
		double cant = Double.valueOf(textCantCompra.getText());
		System.out.println(cant);
		cantDestino.setForeground(Color.black);
		System.out.println();
		cantDestino.setText(""+ moneda.convertir(cant, monedaDestino) + " "+ monedaDestino.getNomenclatura());
		setError(false);
	...
	public void actualizarValores(Cripto cripto, List<Activo> activos) {
		...
		precio.setText("$"+ cripto.getValor_Dolar());
		comboBoxModel.addElement(cripto.getNomenclatura());
		comboBoxModel.addElement(cripto.getNombre_icono());
