...
public class PanelRegistro extends JPanel{
	...
	public PanelRegistro() {
		...
		avisoLabel.setFont(fuenteField);
		gbc.gridwidth = 2;
		gbc.gridheight = 1;
		gbc.gridx = 0;
		gbc.gridy = 6;
	...
	public void usuarioRegistrado() {
		avisoLabel.setForeground(colorCeleste);
		avisoLabel.setText("Usuario Registrado Correctamente.");
	}
	public void yaExisteUsuario() {
		avisoLabel.setForeground(Color.RED);
		avisoLabel.setText("El correo asociado ya esta registrado.");
	}
	public Usuario getUsuario() {
		if(!this.aceptoTYC()) {
			avisoLabel.setText("debe aceptar los terminos y condiciones");
			avisoLabel.setForeground(Color.RED);
			return null;
		}
		...
		if(nombre.isBlank()|| apellido.isBlank()|| email.isBlank() || password.isBlank()) {
			avisoLabel.setText("Por favor, no deje campos en blanco.");
			avisoLabel.setForeground(Color.RED);
			return null;
		}
